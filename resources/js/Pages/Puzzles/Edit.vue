            ...
            >
              <div class="grid grid-cols-1">
                ...
                <input
                  ...
                  placeholder="Name"
                />
                <div v-if="errors.name" class="font-bold text-red-600">
                  {{ errors.name }}
                </div>
              </div>
              <div class="grid grid-cols-1">
                ...
                <div v-if="errors.type" class="font-bold text-red-600">
                  {{ errors.type }}
                </div>
              </div>
              <div class="grid grid-cols-1">
                ...
                />
                <div v-if="errors.description" class="font-bold text-red-600">
                  {{ errors.description }}
                </div>
              </div>
              <div class="grid grid-cols-1">
...
export default {
  ...
  data() {
    return {
      url: this.puzzle.image ? "/storage/" + this.puzzle.image : null,
      form: {
  ...
  methods: {
    submit() {
      ...
      Inertia.post(route("puzzles.update", this.$props.puzzle.id), this.form);
    },
    changeImage(e) {
